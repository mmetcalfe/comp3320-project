...
\begin{abstract}
    ...
    % It is hoped that our virtual environment will be useful as a test-bed
    % for an enhanced VR setup, by creating a realistic 3D scene that naturally limits
    % the user to a small area, while maximising the user's sense of space and
    % scale.
