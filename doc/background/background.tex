    ...
    \subsection{How does Photography Work?}
      \begin{frame}{Light}
        \begin{aquote}{Wikipedia, \href{http://en.wikipedia.org/wiki/Light}{Light}}
          In common with all types of EMR, visible light is emitted and absorbed in \textbf{tiny `packets' called photons}, and exhibits properties of both waves and particles. This property is referred to as the wave–particle duality.
        \end{aquote}
  ...
  \section{Photon Mapping}
    ...
    \subsection{Photon Simulation}
      ...
      \begin{frame}{The photons}
        ...
        \slideframe{1}{image035}
        \slideframe{2}{image036}
        \slideframe{3}{image037}
        \slideframe{4}{image038}
        \slideframe{5}{image039}
      \end{frame}

      \begin{frame}{Illustration}
        \slideframe{1}{image040}
        \slideframe{2}{image041}
        \slideframe{3}{image042}
        \slideframe{4}{image043}
        \slideframe{5}{image044}
        \slideframe{6}{image045}
        \slideframe{7}{image046}
        \slideframe{8}{image047}
        \slideframe{9}{image048}
      \end{frame}
